...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- ADD MOVIE BUTTON-->           
                    <a href="{{url('/staff')}}" class="btn btn-primary ms-auto">Back</a>
            <!-- Navbar-->
                             ...
                             <div class="col-6">
                                <form action="{{url('update-staff/'.$staff->id)}}" method="post">
                                  ...
                                  @method('PUT')
                                    ...
                                    <input type="text" value="{{$staff->username}}" name="username" class="form-control">
                                    <label for="" class="mt-3">Staff Position</label>
                                    <input type="text" name="position" value="{{$staff->position}}" class="form-control">
                                    <label for="" class="mt-3">Staff Image</label>
